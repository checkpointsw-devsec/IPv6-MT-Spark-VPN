...
highlight_message '###################         adding spark2 ##################'
mgmt_cli add simple-gateway -s /home/admin/sid.txt\
        ...
        interfaces.1.ipv6-address "2a04:6447:900:100::20" \
        ...
        interfaces.2.ipv6-address "2a04:6447:900:101::20" \
        ...
        interfaces.3.ipv6-address "2a04:6447:900:102::20" \
...
myUID1=$(mgmt_cli show-generic-objects -s /home/admin/sid.txt name "vpn-gw-2" -f json | jq '.objects[1].uid')
mgmt_cli set-generic-object -s /home/admin/sid.txt uid $myUID1 securityBladesTopologyMode "TOPOLOGY_TABLE" 

cprid_util -server 2a04:6447:900:100::20 -verbose rexec -rcmd /bin/bash -c "LOGNAME=admin bashUser on"
