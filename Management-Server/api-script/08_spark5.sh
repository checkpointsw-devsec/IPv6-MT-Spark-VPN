...
highlight_message '###################         adding spark5 ##################'
mgmt_cli add simple-gateway -s /home/admin/sid.txt\
         ...
         ipv6-address "2a04:6447:900:100::50" \
		ipv4-address "10.1.0.50" \
         firewall true \
		 one-time-password "$otp" \
         trust-settings.initiation-phase 'now' \
         platform-portal-settings.portal-web-settings.main-url "https://[2a04:6447:900:100::50]/" \
         interfaces.1.name "$rugg_vlan100" \
         interfaces.1.ipv6-address "2a04:6447:900:100::50" \
         interfaces.1.ipv6-mask-length "64" \
		 interfaces.1.ipv4-address "10.1.0.50" \
         ...
         interfaces.2.ipv6-address "2a04:6447:900:101::50" \
		 interfaces.2.ipv4-address "10.1.1.50" \
         ...
         interfaces.3.ipv6-address "2a04:6447:900:102::50" \
         interfaces.3.ipv6-mask-length "64" \
		 interfaces.3.ipv4-address "10.1.2.50" \
         ...
         interfaces.4.ipv6-address "2a04:6447:900:5100::1" \
         interfaces.4.ipv6-mask-length "64" \
		 interfaces.4.ipv4-address "10.51.0.1" \
         ...
         interfaces.5.ipv6-address "2a04:6447:900:5101::1" \
         interfaces.5.ipv6-mask-length "64" \
		 interfaces.5.ipv4-address "10.51.1.1" \
         ...
         interfaces.6.ipv6-address "2a04:6447:900:5102::1" \
         interfaces.6.ipv6-mask-length "64" \
		 interfaces.6.ipv4-address "10.51.2.1" \
...
highlight_message '############### enable vpn blade on spark5       ###########'
...
highlight_message '############### add ELS interfaces  spark5       ###########'
mgmt_cli set-simple-gateway -s /home/admin/sid.txt\
         name "vpn-gw-5" \
		 ipv6-address "2a04:6447:900:100::50" \
		 allow-smb true \
		 vpn-settings.vpn-domain-type "manual" \
		 vpn-settings.vpn-domain "Spark5_EncDom46" \
...
myUID0=$(mgmt_cli show-generic-objects -s /home/admin/sid.txt name "vpn-gw-5" -f json | jq '.objects[0].uid')
mgmt_cli set-generic-object -s /home/admin/sid.txt uid $myUID0 	securityBladesTopologyMode "TOPOLOGY_TABLE"  

#myUID1=$(mgmt_cli show-generic-objects -s /home/admin/sid.txt name "vpn-gw-5" -f json | jq '.objects[1].uid')
#mgmt_cli set-generic-object -s /home/admin/sid.txt uid $myUID1 	securityBladesTopologyMode "TOPOLOGY_TABLE"  

cprid_util -server 2a04:6447:900:100::50 -verbose rexec -rcmd /bin/bash -c "LOGNAME=admin bashUser on"
