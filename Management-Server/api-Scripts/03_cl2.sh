...
mgmt_cli add-simple-cluster -s /home/admin/sid.txt\
         ...
         interfaces.1.ipv4-address "10.0.30.3" \
         ...
         interfaces.2.ipv4-address "10.0.40.3" \
         ...
         members.1.interfaces.1.ipv4-address "1.0.30.1" \
         ...
         members.1.interfaces.2.ipv4-address "10.0.40.1" \
         ...
         members.2.interfaces.1.ipv4-address "1.0.30.2" \
         ...
         members.2.interfaces.2.ipv4-address "10.0.40.2" \
...
mgmt_cli set-simple-cluster -s /home/admin/sid.txt\
         name "Cl2" \
		 vpn-settings.interfaces.1.interface-name "eth1-01.300" \
         vpn-settings.interfaces.1.ip-version "ipv6" \
		 vpn-settings.interfaces.2.interface-name "eth1-01.300" \
