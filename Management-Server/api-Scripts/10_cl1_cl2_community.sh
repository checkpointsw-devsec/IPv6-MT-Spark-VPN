...
mgmt_cli add vpn-community-star -s /home/admin/sid.txt \
	...
	override-interfaces.2.interfaces.1.interface-name "$cl2_vlan300" \
    override-interfaces.2.interfaces.1.ip-version "ipv6" \
	override-interfaces.2.interfaces.2.interface-name "$cl2_vlan300" \
    override-interfaces.2.interfaces.2.ip-version "ipv4" 
