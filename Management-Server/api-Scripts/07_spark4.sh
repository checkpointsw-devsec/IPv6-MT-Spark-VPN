...
highlight_message '###################         adding spark4 ##################'
mgmt_cli add-simple-gateway -s /home/admin/sid.txt\
		...
		ipv4-address "10.1.0.40" \
        firewall true \
		one-time-password "$otp" \
        trust-settings.initiation-phase 'now' \
        platform-portal-settings.portal-web-settings.main-url "https://[2a04:6447:900:100::40]/" \
        interfaces.1.name "$rugg_vlan100" \
        interfaces.1.ipv6-address "2a04:6447:900:100::40" \
        interfaces.1.ipv6-mask-length "64" \
		interfaces.1.ipv4-address "10.1.0.40" \
        ...
        interfaces.2.ipv6-address "2a04:6447:900:101::40" \
        interfaces.2.ipv6-mask-length "64" \
		interfaces.2.ipv4-address "10.1.1.40" \
        ...
        interfaces.3.ipv6-address "2a04:6447:900:102::40" \
        interfaces.3.ipv6-mask-length "64" \
		interfaces.3.ipv4-address "10.1.2.40" \
        ...
        interfaces.4.ipv6-address "2a04:6447:900:4100::1" \
        interfaces.4.ipv6-mask-length "64" \
		interfaces.4.ipv4-address "10.41.0.1" \
        ...
        interfaces.5.ipv6-address "2a04:6447:900:4101::1" \
        interfaces.5.ipv6-mask-length "64" \
		interfaces.5.ipv4-address "10.41.1.1" \
        ...
        interfaces.6.ipv6-address "2a04:6447:900:4102::1" \
        interfaces.6.ipv6-mask-length "64" \
		interfaces.6.ipv4-address "10.41.2.1" \
...
highlight_message '############### enable vpn blade on spark4       ###########'
...
highlight_message '############### add ELS interfaces  spark4       ###########'
mgmt_cli set-simple-gateway -s /home/admin/sid.txt\
         name "vpn-gw-4" \
		 ipv6-address "2a04:6447:900:100::40" \
		 allow-smb true \
